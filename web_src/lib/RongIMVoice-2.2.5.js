...
(function(RongIMLib) {
    var RongIMVoice = function() {
        ...
        RongIMVoice.init = function(opt) {
            if (this.notSupportH5) {
                opt = opt || {};
                var player = opt.player || "//cdn.ronghub.com/player-2.0.2.swf";
                var swfobjectLib = opt.swfobject || "//cdn.ronghub.com/swfobject-2.0.0.min.js";
                var div = document.createElement("div");
                div.setAttribute("id", "flashContent");
                document.body.appendChild(div);
                var script = document.createElement("script");
                script.src = swfobjectLib;
                ...
                script.onload = script.onreadystatechange = function() {
                    ...
                    swfobject.embedSWF(player, "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                };
            }
            this.isInit = true;
        };
