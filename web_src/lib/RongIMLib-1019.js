/*
    ...
    yangchuan 2017-8-10 修改
    MemberModifyMessage 消息体增加 existedUserPofiles 属性
...
(function (RongIMLib) {
    var RongIMClient = (function () {
        ...
        RongIMClient.setDeviceId = function (deviceId) {
            RongIMClient._dataAccessProvider.setDeviceId(deviceId);
        };
        /**
        ...
        RongIMClient.prototype.addConversation = function(conversation, callback){
            return RongIMClient._dataAccessProvider.addConversation(conversation, {
                onSuccess: function(){
...
(function (RongIMLib) {
    var WebSQLDataProvider = (function () {
        ...
        WebSQLDataProvider.prototype.setDeviceId = function (deviceId) { };
    ...
    var ObjectTools = (function () {
        ...
        ObjectTools.buildOptions = function (one, opts, protocol) {
            if (typeof one == 'object') {
                for (var key in opts) {
                    if (key == 'fileUploadURL' || key == 'fileQNURL' || key == 'long' || key == 'byteBuffer' || key == 'navi' || key == 'api' ||
